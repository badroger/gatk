...
public final class CombineSegmentBreakpointsIntegrationTest extends CommandLineProgramTest {
    ...
    private static final String INPUT_SEGMENTS_FILE = TEST_SUB_DIR + "combine-segment-breakpoints.tsv.seg";
    private static final String INPUT_SEGMENTS_FILE_NO_SAMHEADER = TEST_SUB_DIR + "combine-segment-breakpoints-no-samheader.tsv.seg";
    private static final String INPUT_SEGMENTS_FILE_ALT_SAMHEADER = TEST_SUB_DIR + "combine-segment-breakpoints-alt-samheader.tsv.seg";
    private static final String GROUND_TRUTH_SEGMENTS_FILE = TEST_SUB_DIR + "combine-segment-breakpoints-comparison.tsv.seg";
    private static final String GROUND_TRUTH_SEGMENTS_FILE_NO_SAMHEADER = TEST_SUB_DIR + "combine-segment-breakpoints-comparison-no-samheader.tsv.seg";
    private static final String INPUT_SEGMENTS_FILE_WITH_DIFFERENT_HEADERS = TEST_SUB_DIR + "combine-segment-breakpoints-different-annotation-headers.tsv.seg";
